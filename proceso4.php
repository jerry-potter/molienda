...
<section class="site-section site-section-light site-section-top themed-background-dark">
    <div class="container">
        <h1 class="animation-slideDown"><i class="fa fa-spinner" aria-hidden="true"></i> <strong>Descripción de proceso n°4</strong></h1>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div id="project-carousel" class="carousel slide" data-ride="carousel" data-interval="3000">
                    ...
                    <div class="carousel-inner text-center">
                        <div class="active item">
                            <img src="img/placeholders/photos/16.JPG" alt="Image 1">
                        </div>
                        <div class="item">
                            <img src="img/placeholders/photos/17.JPG" alt="Image 2">
                        </div>
                        <div class="item">
                            <img src="img/placeholders/photos/19.JPG" alt="Image 2">
                        </div>
            ...
            <div class="col-md-7 visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInQuick" data-element-offset="-100">
                ...
                <h3 class="site-heading"><strong>Peloteando</strong>, ó haciendo pelotas de bagazo.</h3>    
                       <span class="text-muted"><p align="justify">Dicha labor consiste en que cada moledor tendrá que elaborar una cierta cantidad de pelotas que servirán para el cocimiento del jugo de caña, cave recalcar que cuando se inicia la temporada se comienza con leña.</p></span>
                       </div>
                </a>
            </div>
            <!-- END Project Details -->
